...
- __Application__ refers to Cloudisy , the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Cloudisy .
...
- __Website__ refers to Cloudisy , accessible from [cloudisy.top](cloudisy.top).
