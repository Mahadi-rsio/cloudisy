...
export default function App() {
    ...
    return (
      ...
      `}</style>
            ...
            <FloatingBadge delay={0.8} x="80%" y="70%">⚡ 120ms avg latency</FloatingBadge>
                ...
                <div className="relative rounded-2xl p-px" style={{ background: "linear-gradient(135deg, rgba(124,58,237,0.6), rgba(37,99,235,0.4), rgba(56,189,248,0.3), rgba(124,58,237,0.6))" }}>
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="text-xs text-white/30 font-medium">Protected by Cloudisy</span>
                            <div className="flex-1 h-px bg-white/10" />
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-xs text-white/40 leading-relaxed">
                                I agree to the{" "}
                                {" "}and{" "}
                                <a href="/privacy" className="text-violet-400 hover:text-violet-300 transition-colors underline underline-offset-2">Privacy Policy</a>
